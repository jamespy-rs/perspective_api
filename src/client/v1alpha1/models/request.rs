...
/// This models the entire scope of request options for the API, and can be constructed more easily with the request builder in the service. Documentation for the fields is
/// copied from [the website](https://developers.perspectiveapi.com/s/about-the-api-methods?language=en_US).
